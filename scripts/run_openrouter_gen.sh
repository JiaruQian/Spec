...
# Auto-detect libclang for AST decomposition (needed by autospec.decomposition).
...
INPUT_DIR="${INPUT_DIR:-benchmarks/frama-c-problems/test-inputs}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/annotated-openrouter}"
